          ...
          <div className="prose prose-invert max-w-none">
            <div className="space-y-8 text-gray-300">
              ...
              <section>
                ...
                <p className="mb-4">
                  N.E.X.U.S. provides an autonomous AI interaction and execution system designed to:
                </p>
              ...
              <section>
                ...
                <p>
                  ...
                  <a href="mailto:legal@nexus.ai" className="text-blue-400 hover:text-blue-300">
                    legal@nexus.ai
                  </a>
                </p>
              </section>
